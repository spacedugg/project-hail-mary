...
CREATE TABLE "products" (
	...
	"variant_role" text DEFAULT 'standalone' NOT NULL,
	"parent_product_id" text,
	"variation_theme" jsonb,
	"variant_axis_values" jsonb,
	"variant_parent_container" boolean DEFAULT false NOT NULL,
	"content_master" jsonb,
	"content_plan" jsonb,
	"created_at" timestamp with time zone NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "products" ADD CONSTRAINT "products_parent_product_id_products_id_fk" FOREIGN KEY ("parent_product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
