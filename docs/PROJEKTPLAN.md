...
| Live-Qualitäts-Score (qualitativ — ersetzt das separate Accuracy-Prozent-Dashboard) | 🔶 teilweise | Die HEUTIGE Messung bleibt unverändert (Regel-Messung + Pain-Point-/Kaufauslöser-Abdeckung aus den Analysen — bestätigt 21.07.); sie wird nur zusätzlich dauerhaft auf den LIVE-Stand angewendet. Vollständigkeit steckt automatisch als Fehler-Abzug darin. **Retail-Readiness = Live-Score über Schwelle.** Neu: Live-Messung als Dauerlauf, Soll↔Live-Delta, Cockpit-Kachel |
