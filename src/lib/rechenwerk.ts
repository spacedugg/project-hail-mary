...
export const RECHENWERK: KpiGruppe[] = [
  ...
  },
  {
    ...
    eintraege: [
      ...
      { name: "Beleg-Stufe je Erkenntnis", formel: "Erwähnungen der Beleg-Aspekte gegen die Stichprobe: ≥20 Erwähnungen ODER ≥15 % stark · ≥8 ODER ≥5 % mittel · sonst dünn · ohne Zählwert unbeziffert — immer mit ‚n von m Reviews' ausgewiesen", quelle: "D138", code: "src/lib/reviews/konfidenz.ts (belegStufe)" },
