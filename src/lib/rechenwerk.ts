...
export const RECHENWERK: KpiGruppe[] = [
  ...
  },
  {
    ...
    eintraege: [
      ...
      { name: "Tendenz gemischter Erkenntnisse", formel: "Summe der verifizierten Fundstellen je Seite (Kaufausloeser vs. Pain Points) einer Karte — mehr positiv → ueberwiegend positiv, mehr negativ → ueberwiegend negativ, gleich → ausgeglichen; nur bei Karten mit Zaehlwerten BEIDER Seiten, nie von der KI behauptet", quelle: "D171", code: "src/lib/reviews/verdichtung.ts (kartenTendenz)" },
