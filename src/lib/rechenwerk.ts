...
export const RECHENWERK: KpiGruppe[] = [
  ...
  },
  {
    ...
    eintraege: [
      ...
      { name: "Bullet-Aufbau (Benefit zuerst)", formel: "Headline in Versalien = Benefit-Aussage in den ersten 5–8 Wörtern (nie Feature-Name); dann Feature als Beleg + Konkretes (Material/Maß/Prüfnorm/Garantie/Use Case); drei Jobs je Bullet: Einwand entkräften + Use Case bestätigen + Secondary Keyword natürlich", quelle: "Blog 07/2026 (knowledge/sources/blog-bullets-backend-2026-07.md), D98", code: "src/lib/recipes/listing.ts (Prompt — semantisch, kein Gate-Check)" },
